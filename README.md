...
2. Luego, conectamos los dispositivos. Para realizar las conexiones de la red, utilizamos cables de cobre, que son los más comunes en este tipo de configuraciones (representados por líneas negras continuas). El router se conectó al switch mediante el puerto GigabitEthernet0/0/0 del router hacia el puerto FastEthernet0/3 del switch. Luego, conectamos las PCs al switch utilizando los puertos FastEthernet0/1 y FastEthernet0/2 del switch, que van respectivamente a los puertos FastEthernet0 de cada computadora.
